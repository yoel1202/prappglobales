...
<div class="row">
    <div class="col-sm-3">
        <a id="nom2" href="" class="btn btn-danger btn-block btn-compose-email">Compose Email</a>
        <ul class="nav nav-pills nav-stacked nav-email shadow mb-20">
            ...
            <li>
                <a href="#mail-compose.html"><i class="fa fa-envelope-o"></i>Mensajes </a>
            </li>
            <li>
                <a href="#"><i class="fa fa-list"></i>Lista de productos</a>
            </li>
          
            <li><a href="categories.php"> <i class="fa fa-plus-circle"></i>Vender</a></li>
        </ul><!-- /.nav -->

        <h5 class="nav-email-subtitle">Mas</h5>
        <ul class="nav nav-pills nav-stacked nav-email mb-20 rounded shadow">
            <li>
                <a href="#">
                    <i class="fa fa-folder-open"></i> Ayuda  <span class="label label-danger pull-right">3</span>
                </a>
            </li>
