            ...
            <div class="wrap">
                ...
                <div class="user">
                    ...
                    <div class="form-wrap">
                        <!-- TABS -->
                    	<div class="tabs">
                            <h3 class="login-tab"><a class="log-in active" href="#login-tab-content"><span>Iniciar sesion<span></a></h3>
                    		<h3 class="signup-tab"><a class="sign-up" href="#signup-tab-content"><span>Registrar Ahora</span></a></h3>
                    	</div>
                        <!-- TABS CONTENT -->
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" action="" method="post">
                    				<input type="text" class="input" id="user_login" autocomplete="off" placeholder="Nombre de usuario o correo ">
                    				<input type="password" class="input" id="user_pass" autocomplete="off" placeholder="Contraseña">
                    				<input type="checkbox" class="checkbox" checked id="remember_me">
                    				<label for="remember_me">Recordar sesion</label>
                    				<input type="submit" class="button" value="Iniciar sesion">
                    			</form>
                    			<div class="help-action">
                    				<p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="forgot" href="#">Olvido su contraseña?</a></p>
                    			</div>
                    		</div>
                            <!-- TABS CONTENT SIGNUP -->
                    		<div id="signup-tab-content">
                    			<form class="signup-form" action="" method="post">
                                <input type="text" class="input" id="user_name" autocomplete="off" placeholder="Nombre Usuario">
                    				<input type="email" class="input" id="user_email" autocomplete="off" placeholder="Correo">
                    				<input type="text" class="input" id="user_name" autocomplete="off" placeholder="Nombre">
                                    <input type="text" class="input" id="user_name" autocomplete="off" placeholder="Cedula">
                                    <input type="text" class="input" id="user_name" autocomplete="off" placeholder="Telefono">
                    				<input type="password" class="input" id="user_pass" autocomplete="off" placeholder="Contraseña">
                                  <input type="password" class="input" id="user_pass" autocomplete="off" placeholder="Confrimar contraseña">
                    				<input type="submit" class="button" value="Registrar Ahora">
                    			</form>
                    			<div class="help-action">
                    				<p>Aceptas todos terminos y condiciones</p>
                    				<p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="agree" href="#">terminos y condiciones</a></p>
                    			</div>
                    		</div>
                    	</div>
                	</div>
...
#slideshow .one {
    background-image: url("whatcher.png");
    background-repeat: no-repeat;
