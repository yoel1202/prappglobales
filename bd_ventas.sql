...
-- -----------------------------------------------------
-- Table `bd_ventas`.`tbl_page`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_ventas`.`tbl_page` (
  `idtbl_page` INT NOT NULL AUTO_INCREMENT,
  `tbl_manager_idtbl_administrador` INT(11) NOT NULL,
  PRIMARY KEY (`idtbl_page`),
  INDEX `fk_tbl_page_tbl_manager1_idx` (`tbl_manager_idtbl_administrador` ASC),
  CONSTRAINT `fk_tbl_page_tbl_manager1`
...
CREATE TABLE IF NOT EXISTS `bd_ventas`.`tbl_agreement` (
  ...
  `tbl_page_idtbl_page` INT NOT NULL,
  PRIMARY KEY (`idtbl_agreement`),
  INDEX `fk_tbl_agreement_tbl_page1_idx` (`tbl_page_idtbl_page` ASC),
  CONSTRAINT `fk_tbl_agreement_tbl_page1`
    FOREIGN KEY (`tbl_page_idtbl_page`)
    REFERENCES `bd_ventas`.`tbl_page` (`idtbl_page`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `bd_ventas`.`tbl_subcategories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_ventas`.`tbl_subcategories` (
...
CREATE TABLE IF NOT EXISTS `bd_ventas`.`tbl_productos` (
  ...
  CONSTRAINT `tbl_productos_ibfk_2`
    ...
    REFERENCES `bd_ventas`.`tbl_subcategories` (`idtbl_subcategorias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
